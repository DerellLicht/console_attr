...
CPPSRC=dialog.cpp console.attr.cpp regif.cpp ezfont.cpp\
...
dialog.o: resource.h der_libs/common.h console.attr.h ezfont.h regif.h
console.attr.o: der_libs/common.h console.attr.h
regif.o: der_libs/common.h regif.h
ezfont.o: ezfont.h
